...
namespace Market.ViewModel.DataVM
{
    ...
    public class SpotVM : BaseVM
    {
        ...
        public SalespersonVM Salesperson
        {
            ...
            set { _spot.Salesperson = value.Salesperson; }
        }
        ...
        {
            get { return (ObservableCollection<SpotSDMVM>)(from ssdm in _spot.SpotSDMs select new SpotSDMVM(ssdm)); }
        }
        ...
        public ObservableCollection<SDMVM> SDMs
        {
            get
            {
                return (ObservableCollection<SDMVM>)(from sdm in _spot.SpotSDMs select new SDMVM(sdm.SDM));
                //var res = new ObservableCollection<SDM>();
                //if (SpotSDMs != null)
        ...
        /// </summary>
        public void Save()
        { MarketProxy.Proxy.UpdateOne(SpotMapper.Mapper.Pack(this._spot), Middleware.UpdateType.Save); }
