...
namespace Market.Model.Entities
{
    ...
    public class CustomerSelectedItems
    {
        ...
        /// <summary>
        /// Gets instance of CustomerSelectedItems class by id.
        /// </summary>
        /// <param name="csiId">Id of CustomerSelectedItems in database.</param>
        /// <returns>Instance of CustomerSelectedItems class otherwise null.</returns>
        internal static CustomerSelectedItems GetById(string csiId)
        {
            var csi = CustomerSelectedItemsMapper.Mapper.UnPack(MarketProxy.Proxy.GetData("CustomerSelectedItems", Middleware.MethodType.GetById, string.Empty, Guid.Parse(csiId)));
        ...
        /// <summary>
        /// Gets the text saying if a seleced item is submited or not.
        /// </summary>
        public string IsSubmitedString { get { return IsSubmited == true ? "Подтверждено." : "He подтверждено."; } }
