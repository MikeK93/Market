...
namespace Market.Model.Entities
{
    ...
    public class Spot
    {
        ...
        /// <summary>
        /// Gets instance of a Spot class by id.
        /// </summary>
        /// <param name="sId">Id of a concreate spot.</param>
        /// <returns>Instance of a Spot class from the database.</returns>
        internal static Spot GetById(string sId)
        {
            try
            {
                var spot = SpotMapper.Mapper.UnPack(MarketProxy.Proxy.GetData("Spot", Middleware.MethodType.GetById, string.Empty, Guid.Parse(sId)));
                return spot[0];
            }
        ...
        /// </summary>
        public static List<Spot> GetAllAvailableSpots
        {
            get { return SpotMapper.Mapper.UnPack(MarketProxy.Proxy.GetData("Spot", Middleware.MethodType.GetByQuery, "SalespersonID IS NOT NULL", Guid.Empty)); }
        }
        ...
        /// <summary>
        /// Gets or sets longitute and latitute of a spot.
        /// </summary>
